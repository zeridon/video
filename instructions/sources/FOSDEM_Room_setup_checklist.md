...
- [ ] Connect speaker (clip-on) microphone to IN3 on slides box
...
- [ ] Connect HDMI cable to slides box HDMI IN port to be used by presenter - leave other end on desk
...
- [ ] Repeat microphone test with VOC
  ...
  - [ ] Make sure that a VOC member has ACKnowledged your request
...
This is the best layout for the pelican cases, videoboxes (and their PSUs) to fit everything else around or above it.

- Roll up each cable and put it back in its bag
- Be sure to put the room box contents checklist at the very top inside of the box once you're done

![](per_room_video_box_filled.jpg){ width=100% }
