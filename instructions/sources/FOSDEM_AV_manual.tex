...
Video coordination happens through the following channels:in \#video:fosdem.org, walkies. The chat is web accessible through https://chat.fosdem.org/\#/room/\#video:fosdem.org .
...
Every room has one gray box with the equipment neededd to setup the room. The box is labeled with the room number and includes a checklist with all equipment inside and a checklist for the setup.
