...
SCREENSHOT_FILE =  '/mnt/ssd/statuspage/screenshot.jpg'
LOGO_FILE =  'logo.png'
...
def update_sysinfo(screen):
	...
	image.blit(font.render("load: " + uptime_avg1 + ", " + uptime_avg5 + ", " + uptime_avg15, 1, RED if float(uptime_avg1) > 1.8 else WHITE), (0, 30))
	...
	image.blit(font.render("stream: udp://FIXME", 1, WHITE), (0, 75))
